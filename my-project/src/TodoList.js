      ...
      {todos.map((todo, index) => (
        <li key={index} className="mb-4">
          <input
            ...
            className="mt-3 w-5/6 font-sans font-semibold rounded-md border-0 py-3 pl-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-200 sm:text-sm sm:leading-6"
            value={todo.text}
